<html lang="en">
  ...
  <body>
    ...
    <!--Contenedor del menu de las facultades-->
    <div class="button-menu--container">
      <ul class="button-holder scrollbar-menu">
        <li class="scrollbar-menu__el">
          <div class="button button-style hover-border">
            Ingenieria Y Aquitectura
          </div>
        ...
        <li class="scrollbar-menu__el">
          ...
          <ul class="scrollbar-menu__el--sub">
            <li><a href="#">Licenciatura En Filosofia</a></li>
            <li><a href="#">Licenciatura En Idioma Ingles</a></li>
            <li><a href="#">Licenciatura En Psicologia</a></li>
            <li><a href="#">Licenciatura En Teologia</a></li>
          </ul>
        </li>
        <li class="scrollbar-menu__el">
          <div class="button button-style hover-border">Ciencias Juridicas</div>
          <ul class="scrollbar-menu__el--sub">
            <li><a href="#">Licenciatura En Ciencias Juridicas</a></li>
          </ul>
        </li>
      </ul>
      <ul class="button-holder scrollbar-menu">
        <li class="scrollbar-menu__el">
          ...
          <ul class="scrollbar-menu__el--sub">
            <li><a href="#">Tecnico En Mercadeo</a></li>
            <li><a href="#">Tecnico En Produccion Multimedia</a></li>
            <li><a href="#">Licenciatura En Mercadeo</a></li>
            <li><a href="#">Licenciatura En Comunicacion Social</a></li>
          </ul>
        </li>
        <li class="scrollbar-menu__el">
          <div class="button button-style hover-border">Educacion</div>
          <ul class="scrollbar-menu__el--sub">
            <li><a href="#">Profesorado En Idioma Ingles</a></li>
            <li><a href="#">Profesorado En Teologia</a></li>
          </ul>
        </li>
        <li class="scrollbar-menu__el">
          <div class="button button-style hover-border">
          ...
          <ul class="scrollbar-menu__el--sub">
            <li><a href="#">Tecnico En Contaduria</a></li>
            <li><a href="#">Licenciatura En Administracion De Empresas</a></li>
            <li><a href="#">Licenciatura En Contaduria Publica</a></li>
            <li><a href="#">Licenciatura En Economia</a></li>
          </ul>
        </li>
      </ul>
      <!--Contenedor del menu de las facultades-->
